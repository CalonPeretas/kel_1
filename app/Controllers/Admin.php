...
' . $data->namaBarang;
    ...
    public function dwnBrgDipinjam()
    {
        ...
        $print .= '<h3 class="tengah">Daftar Pemakaian Aset Modal <br> Universitas Teknokat Indonesia <br> Tahun 2023</h3>';
        ...
        $mpdf->SetAuthor('Kelompok 1');
        $mpdf->SetCreator('Kelompok 1');
        $mpdf->SetWatermarkText('Kelompok 1');
        $mpdf->showWatermarkText = true;
        $mpdf->watermarkTextAlpha = 0.1;
        $mpdf->WriteHTML($print);

        $a = $mpdf->Output('Daftar Pemakaian Aset Modal.pdf', 'D');
    }
    ...
    public function dwnBrg()
    {
        ...
        $print .= '<h3 class="tengah">Daftar Aset Modal dan Aset Habis Pakai <br> Universitas Teknokat Indonesia <br> Tahun 2023</h3>';
        $print .= '<table id="customers">
                    <thead>
                        <tr>
                            <th>No</th>
    ...
    public function dwnBrgDiambil()
    {
        ...
        $a = $mpdf->Output('Daftar Pemakaian Aset Habis Pakai.pdf', 'D');
    }
}
