        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Pesan Aset</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        <div class="input-group input-group-outline">
                            ...
                            <input type="number" name="jumlahBarang" id="jumlahBarang" class="form-control" placeholder="Masukkan jumlah Aset">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="input-group input-group-outline">
                ...
                <small class="ms-3 text-info">Pastikan mengecek stok aset sebelum melakukan pesanan</small>
            ...
            <div class="card">
                <div class="card-header p-3 pt-2 mb-1">
                    <div class="bg-gradient-info shadow-info text-center border-radius-xl mt-n4 p-3">
                        <i class="text-white" style="margin-top: 0; display:inline-block">Daftar Aset</i>
                    </div>
